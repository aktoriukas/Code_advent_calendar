...
coordinates.forEach(function ( direction, index) {

    let lenght = direction.length;
    let number = parseInt(direction.slice(1, lenght));

    location.number = number;
    location.case = direction[0];
